...
namespace CV.Utils.Utils.Datetime
{
    public class DateTimeHelper
    {
        ...
        public static DateTimeOffset ConvertTimeZone(DateTimeOffset dateCurrent, string timeZoneId)
        {
            return TimeZoneInfo.ConvertTime(dateCurrent, GetTimeZoneInfo(timeZoneId));
        }
    }
}
