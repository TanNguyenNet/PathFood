...
namespace CV.DI
{
    public static class IServiceCollectionExtensions
    {
        ...
        public static IServiceCollection PrintServiceAddedToConsole(this IServiceCollection services, [NotNull]CvPrintRegisteredToConsoleOptions configure)
        {
            return services.PrintServiceAddedToConsole(_ =>
            {
                _.ListAssemblyName = configure.ListAssemblyName;
        ...
        public static IServiceCollection PrintServiceAddedToConsole(this IServiceCollection services, [NotNull]Action<CvPrintRegisteredToConsoleOptions> configure)
        {
            services.Configure(configure);

            CvPrintRegisteredToConsoleOptions options = configure.GetValue();
